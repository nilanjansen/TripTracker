...
namespace TripTrackerServices.Data
{
    public class TripContext:DbContext
    {
        ...
        public static void SeedData(IServiceProvider serviceProvider)
        {
                ...
                context.Trips.AddRange(new Trip[]
            {
                ...
                DbContextOptionsBuilder _dbContextOptionsBuilder = new DbContextOptionsBuilder();
                _dbContextOptionsBuilder.EnableSensitiveDataLogging(true);
                context.SaveChanges();
